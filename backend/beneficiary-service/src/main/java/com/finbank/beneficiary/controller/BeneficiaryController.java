...
public class BeneficiaryController {
    ...
    public BeneficiaryResponse get(@PathVariable String reference) {
        return service.getBeneficiary(reference);
    }

    @GetMapping("/customer/{customerNumber}")
    public List<BeneficiaryResponse> getCustomerBeneficiaries(@PathVariable String customerNumber) {
