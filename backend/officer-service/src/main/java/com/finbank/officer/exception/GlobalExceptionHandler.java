package com.finbank.officer.exception;

import com.finbank.officer.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ApiErrorResponse officer(OfficerException ex, HttpServletRequest request) {
