package com.finbank.support.exception;
...
@RestControllerAdvice public class GlobalExceptionHandler{
 @ExceptionHandler(SupportException.class) @ResponseStatus(HttpStatus.BAD_REQUEST) public Map<String,Object> support(SupportException e,HttpServletRequest r){return error(400,e.getMessage(),r.getRequestURI());}
